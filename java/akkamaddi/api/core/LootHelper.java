...
public class LootHelper 
{
	 ...
	 */
	public static void addLoot(String location, ItemStack stack, int minChance,
			int maxChance, int itemWeight) 
	{
		ChestGenHooks.getInfo(location).addItem(
				new WeightedRandomChestContent(stack, minChance, maxChance,
						itemWeight));
	} // end addLoot()
	
} // end class LootHelper
